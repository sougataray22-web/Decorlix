...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-6xl mx-auto px-4 py-16 flex flex-col md:flex-row items-center gap-8">
          <div className="flex-1 text-white">
            ...
            <div className="flex gap-3 flex-wrap">
              <Link to="/products" className="bg-white text-gray-900 font-bold px-7 py-3 rounded-full hover:bg-gray-100 transition text-sm">
                Shop Now
              </Link>
              <Link to="/products?sort=discount" className="border-2 border-white/60 text-white font-semibold px-7 py-3 rounded-full hover:bg-white/10 transition text-sm">
                View Offers
              </Link>
            </div>
          ...
          <div className="text-[120px] md:text-[160px] select-none drop-shadow-2xl" style={{ animation:"bounce 3s infinite" }}>
            {cur.img}
          </div>
        </div>
      </section>
      ...
      {/* 2. ★ LATEST PRODUCTS (Hero এর পরেই) ★ */}
      ...
      {/* 3. ★ SHOP BY CATEGORY (Products এর পরে) ★ */}
      ...
      {/* 5. Promo Banners */}
      <section className="max-w-7xl mx-auto px-4 py-10 grid md:grid-cols-2 gap-4">
        ...
        <div className="bg-gradient-to-r from-purple-600 to-indigo-600 rounded-2xl p-7 text-white flex justify-between items-center">
          <div>
            ...
            <Link to="/products?category=festive-decor" className="bg-white text-purple-600 font-bold px-5 py-2 rounded-full text-sm hover:bg-purple-50">
              Explore
            </Link>
          </div>
          <span className="text-6xl">🪔</span>
